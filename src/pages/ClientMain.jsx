...
<div className="w-auto mx-auto">
  <div className={`bg-green-200 text-green-800 p-6 py-12 rounded-lg shadow-md max-w-md transition-transform duration-300 hover:scale-105 ${expandedSection === null ? '' : 'hidden'} ${expandedSection === null ? '' : 'w-full md:w-1/3 lg:w-1/4 xl:w-1/5'}`}>
    <h2 className="text-3xl text-center font-bold text-green-800 mb-4 md:mb-8">Order our services here!</h2>
    <div className="mb-4">
      <select
        id="category"
        value={category}
